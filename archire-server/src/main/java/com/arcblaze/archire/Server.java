package com.arcblaze.archire;

import static com.arcblaze.archire.model.Role.ADMIN;
import static com.arcblaze.archire.model.Role.USER;
...
import com.arcblaze.archire.rest.ArctimeApplication;
import com.arcblaze.archire.security.SecurityRealm;
...
public class Server {
	...
	public Server() {
		...
		SecurityRealm realm = new SecurityRealm("archire");
		tomcat.getEngine().setRealm(realm);

		Context context = null;
		if (Property.SERVER_DEVELOPMENT_MODE.getBoolean())
			context = tomcat.addContext("", "archire-web/src/main/webapp");
		else
		...
		loginConfig.setRealmName("archire");
